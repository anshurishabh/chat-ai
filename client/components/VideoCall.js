          ...
          {callStatus === 'incoming' && (
            <div className="absolute inset-0 flex flex-col items-center justify-center bg-gray-900/80">
              ...
              <div className="flex gap-6">
                <button
                  onClick={endCall}
                  className="w-16 h-16 bg-red-500 hover:bg-red-400 rounded-full flex items-center justify-center text-2xl transition-all"
                >
                  📵
                </button>
                <button
                  onClick={answerCall}
                  className="w-16 h-16 bg-green-500 hover:bg-green-400 rounded-full flex items-center justify-center text-2xl transition-all animate-bounce"
                >
                  📞
                </button>
              </div>
